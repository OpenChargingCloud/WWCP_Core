...
namespace de.eMI3
{
    ...
    /// </summary>
    public class EVSProvider_Id : IEquatable<EVSProvider_Id>, IComparable<EVSProvider_Id>, IComparable
    {
        ...
        /// </summary>
        public EVSProvider_Id(String String)
        {
            _Id = String.Trim();
        }
        ...
        /// </summary>
        public static EVSProvider_Id New
        {
            get
            {
                return new EVSProvider_Id(Guid.NewGuid().ToString());
            }
        }
        ...
        /// Clone an EVSP_Id.
        /// </summary>
        public EVSProvider_Id Clone
        {
            get
            {
                return new EVSProvider_Id(_Id);
            }
        }
        ...
        public static Boolean operator == (EVSProvider_Id EVSP_Id1, EVSProvider_Id EVSP_Id2)
        {
        ...
        public Int32 CompareTo(Object Object)
        {
            ...
            var EVSP_Id = Object as EVSProvider_Id;
        ...
        public Int32 CompareTo(EVSProvider_Id EVSP_Id)
        {
        ...
        public Boolean Equals(EVSProvider_Id EVSP_Id)
        {
