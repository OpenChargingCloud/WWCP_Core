...
namespace org.emi3group
{
    ...
    /// <summary>
    /// A Charging Station Search Provider (CSSP).
    /// </summary>
                                  ...
                                  IEnumerable<EVSPool>
    {
        ...
        #region (internal) SearchProvider()

        /// <summary>
        /// Create a new Charging Station Search Provider (CSSP).
        /// </summary>
        internal SearchProvider(RoamingNetwork  RoamingNetwork)
            : this(SearchProvider_Id.New, RoamingNetwork)
        { }

        #endregion

        #region (internal) SearchProvider(Id)

        /// <summary>
        /// Create a new Charging Station Search Provider (CSSP)
        /// having the given SearchProvider_Id.
        /// </summary>
        /// <param name="Id">The EVSPool Id.</param>
        internal SearchProvider(SearchProvider_Id  Id,
        ...
        public Int32 CompareTo(Object Object)
        {
            ...
            var EVSE_Operator = Object as SearchProvider;
        ...
        public Int32 CompareTo(SearchProvider EVSE_Operator)
        {
        ...
        public Boolean Equals(SearchProvider EVSE_Operator)
        {
