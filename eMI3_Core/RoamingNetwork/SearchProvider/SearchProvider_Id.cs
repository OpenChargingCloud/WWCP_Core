...
namespace org.emi3group
{
    ...
    /// <summary>
    /// The unique identification of a Charging Station Search Provider (CSSP Id).
    /// </summary>
    public class SearchProvider_Id : IId, IEquatable<SearchProvider_Id>, IComparable<SearchProvider_Id>
    {
        ...
        #region SearchProvider_Id()

        /// <summary>
        /// Generate a new Charging Station Search Provider identification (CSSP Id).
        /// </summary>
        public SearchProvider_Id()
        {
        ...
        #region SearchProvider_Id(String)

        /// <summary>
        /// Generate a new Charging Station Search Provider identification (CSSP Id)
        /// based on the given string.
        /// </summary>
        public SearchProvider_Id(String String)
        {
            _Id = String.Trim();
        }
        ...
        /// </summary>
        public static SearchProvider_Id New
        {
            get
            {
                return new SearchProvider_Id(Guid.NewGuid().ToString());
            }
        }
        ...
        /// Clone an EVSP_Id.
        /// </summary>
        public SearchProvider_Id Clone
        {
            get
            {
                return new SearchProvider_Id(_Id);
            }
        }
        ...
        public static Boolean operator == (SearchProvider_Id EVSP_Id1, SearchProvider_Id EVSP_Id2)
        {
        ...
        public Int32 CompareTo(Object Object)
        {
            ...
            var EVSP_Id = Object as SearchProvider_Id;
        ...
        public Int32 CompareTo(SearchProvider_Id EVSP_Id)
        {
        ...
        public Boolean Equals(SearchProvider_Id EVSP_Id)
        {
