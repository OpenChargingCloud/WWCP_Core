...
namespace org.emi3group
{
    ...
    public class Country : IEquatable<Country>, IComparable<Country>, IComparable
    {
        ...
        /// <summary>
        /// The ISO Numeric Code UN M49 Numerical Code.
        /// </summary>
        ...
        /// <param name="NumericCode">The ISO Numeric Code UN M49 Numerical Code.</param>
        public Country(String CountryName, String Alpha2Code, String Alpha3Code, String NumericCode)
        {
        ...
        ///// or returns Country.BadRequest.
        ///// </summary>
        ///// <param name="myCode">A Country code as string</param>
        ///// <returns>A Country</returns>
        //public static Country ParseString(String myCode)
        //{
        ...
        //        var myCountry = (from   _FieldInfo in typeof(Country).GetFields()
        //                                let    _Country = _FieldInfo.GetValue(null) as Country
        //                                where  _Country != null
        //                                where  _Country.Code == _Code
        //                                select _Country).FirstOrDefault();
        ...
        //    return Country.BadRequest;

        //}

        //#endregion

        //#region TryParseString(myCode, out myCountry)

        ///// <summary>
        ///// Tries to find the apropriate Country for the given string.
        ///// </summary>
        ///// <param name="myCode">A Country code</param>
        ///// <param name="myCountry">The parsed Country</param>
        ///// <returns>true or false</returns>
        //public static Boolean TryParseString(String myCode, out Country myCountry)
        //{
        ...
        //        myCountry = (from   _FieldInfo in typeof(Country).GetFields()
        //                            let    _Country = _FieldInfo.GetValue(null) as Country
        //                            where  _Country != null
        //                            where  _Country.Code == _Code
        //                            select _Country).FirstOrDefault();
