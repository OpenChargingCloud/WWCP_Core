        ...
        public void ChargingPool_Init_DefaultStatus_Test()
        {
                ...
                DE_GEF         is not null)
            {
                ...
                var DE_GEF_P1234 = DE_GEF.CreateChargingPool(
                                              ...
                                              Description:         I18NString.Create(Languages.de, "powered by GraphDefined Pool GmbH")
                                          );
                ...
                if (DE_GEF_P1234 is not null)
                {
                    ...
                    Assert.AreEqual ("powered by GraphDefined Pool GmbH",       DE_GEF_P1234.Description.FirstText());
