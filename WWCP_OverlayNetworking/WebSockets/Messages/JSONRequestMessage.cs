...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking.WebSockets
{
    ...
    /// <summary>
    /// An EEBus JSON request message transport container.
    /// </summary>
                                    ...
                                    CancellationToken  CancellationToken   = default)
    {
        ...
        /// <summary>
        /// Create a new EEBus JSON request message transport container based on the given JSON request.
        /// </summary>
        /// <param name="Request">A request message.</param>
        /// <param name="SerializedRequest">The serialized request message.</param>
        public static JSONRequestMessage FromRequest(IRequest  Request,
                                       ...
                                       CancellationToken                                  CancellationToken      = default)
        {
            ...
            try
            {
                    ...
                    JSONArray[3].Type          == JTokenType.Object)
                {
                    ...
                    RequestMessage = new JSONRequestMessage(
        ...
        public JSONRequestMessage ChangeNetworking(NetworkingNode_Id?  NewDestinationId    = null,
        ...
        public JSONRequestMessage ChangeDestionationId(NetworkingNode_Id NewDestinationId)
        ...
        public JSONRequestMessage AppendToNetworkPath(NetworkingNode_Id NetworkingNodeId)
