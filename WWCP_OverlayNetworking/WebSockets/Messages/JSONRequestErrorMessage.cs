...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking.WebSockets
{
                                         ...
                                         CancellationToken  CancellationToken   = default)
    {
        ...
        public static JSONRequestErrorMessage CouldNotParse(Request_Id  RequestId,
                                                          String      Action,
        ...
        public static JSONRequestErrorMessage CouldNotParse(EventTracking_Id  EventTrackingId,
                                                          Request_Id        RequestId,
                                                          String            Action,
                                                          JObject           JSONObjectRequest,
                                                          String?           ErrorResponse   = null)
        ...
        public static JSONRequestErrorMessage FormationViolation(Request_Id  RequestId,
                                                               String      Action,
                                                               JObject     JSONObjectRequest,
                                                               Exception   Exception)
        ...
        public static JSONRequestErrorMessage FormationViolation(EventTracking_Id  EventTrackingId,
                                                               Request_Id        RequestId,
                                                               String            Action,
                                                               JObject           JSONObjectRequest,
                                                               Exception         Exception)
        ...
        public static JSONRequestErrorMessage InternalError(String            Sender,
                                                          EventTracking_Id  EventTrackingId,
                                       ...
                                       NetworkingNode_Id?                              ImplicitSourceNodeId   = null)
        {
            ...
            try
            {
                ...
                ErrorMessage = new JSONRequestErrorMessage(
                                   Timestamp.Now,
                                   EventTracking_Id.New,
                                   NetworkingMode.Standard,
                                   NetworkingNode_Id.Zero,
