...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking.WebSockets
{
    ...
    /// <summary>
    /// A EEBus WebSocket JSON response error message (EEBus v2.1 draft!)
    /// </summary>
    ...
    /// <param name="ErrorCode">An EEBus error code.</param>
    /// <param name="ErrorDescription">An optional error description.</param>
    /// <param name="ErrorDetails">Optional error details.</param>
    /// <param name="CancellationToken">The cancellation token.</param>
    public class JSONResponseErrorMessage(DateTimeOffset     ResponseTimestamp,
                                          ...
                                          CancellationToken  CancellationToken   = default)
    {
        ...
        public static JSONResponseErrorMessage CouldNotParse(Request_Id  RequestId,
                                                          String      Action,
        ...
        public static JSONResponseErrorMessage CouldNotParse(EventTracking_Id  EventTrackingId,
                                                          Request_Id        RequestId,
                                                          String            Action,
                                                          JObject           JSONObjectRequest,
                                                          String?           ErrorResponse   = null)
        ...
        public static JSONResponseErrorMessage FormationViolation(Request_Id  RequestId,
                                                               String      Action,
                                                               JObject     JSONObjectRequest,
                                                               Exception   Exception)
        ...
        public static JSONResponseErrorMessage FormationViolation(EventTracking_Id  EventTrackingId,
                                                               Request_Id        RequestId,
                                                               String            Action,
                                                               JObject           JSONObjectRequest,
                                                               Exception         Exception)
        ...
        public static JSONResponseErrorMessage InternalError(String            Sender,
                                                          EventTracking_Id  EventTrackingId,
            ...
            => new (Timestamp.Now,
                    ...
                    $"The EEBus message received in '{Sender}' led to an exception!",
                    new JObject(
        ...
        #region (static) InternalError     (Sender, EventTrackingId, EEBusArrayRequest,  Exception, RequestId = null)

        public static JSONResponseErrorMessage InternalError(String            Sender,
                                                          EventTracking_Id  EventTrackingId,
                                                          JArray            EEBusArrayRequest,
                                                          Exception         Exception,
                                                          Request_Id?       RequestId   = null)
            ...
            => new (Timestamp.Now,
                    ...
                    new JObject(
                        new JProperty("eventTrackingId",  EventTrackingId.ToString()),
                        new JProperty("request",          EEBusArrayRequest),
                        new JProperty("exception",        Exception.Message),
                        new JProperty("stacktrace",       Exception.StackTrace)
                    ));
        ...
        #region (static) InternalError     (Sender, EventTrackingId, EEBusBinaryRequest, Exception, RequestId = null)

        public static JSONResponseErrorMessage InternalError(String            Sender,
                                                          EventTracking_Id  EventTrackingId,
                                                          Byte[]            EEBusBinaryRequest,
                                                          Exception         Exception,
                                                          Request_Id?       RequestId   = null)
            ...
            => new (Timestamp.Now,
                    ...
                    new JObject(
                        new JProperty("eventTrackingId",  EventTrackingId.ToString()),
                        new JProperty("request",          EEBusBinaryRequest.ToBase64()),
                        new JProperty("exception",        Exception.Message),
                        new JProperty("stacktrace",       Exception.StackTrace)
                    ));
        ...
        public static Boolean TryParse(JArray                                          JSONArray,
                                       [NotNullWhen(true)] out JSONResponseErrorMessage?  ErrorMessage,
                                       NetworkingNode_Id?                              ImplicitSourceNodeId   = null)
        {
            ...
            try
            {
                ...
                ErrorMessage = new JSONResponseErrorMessage(
                                   Timestamp.Now,
                                   EventTracking_Id.New,
                                   NetworkingMode.Standard,
                                   NetworkingNode_Id.Zero,
