...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking
{
    ...
    /// <summary>
    /// An EEBus CSE cryptographic signature.
    /// </summary>
                             ...
                             IEquatable<Signature>
    {
        ...
        /// <summary>
        /// Create a new EEBus CSE cryptographic signature.
        /// </summary>
            ...
            try
            {
                ...
                if (JSON.ParseOptionalJSON("customData",
                                           ...
                                           (JObject json, [NotNullWhen(true)] out CustomData? customData, [NotNullWhen(false)] out String? errorResponse)
                                                 => OverlayNetworking.CustomData.TryParse(json, out customData, out errorResponse, CustomCustomDataParser),
