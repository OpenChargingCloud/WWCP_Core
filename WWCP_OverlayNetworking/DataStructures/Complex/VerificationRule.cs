...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking
{
    ...
    /// <summary>
    /// An EEBus CSE cryptographic verificationRule verification entry.
    /// </summary>
                                    ...
                                    IEquatable<VerificationRule>
    {
        ...
        /// <summary>
        /// Create a new EEBus CSE cryptographic verificationRule verification entry.
        /// </summary>
                                       ...
                                       CustomJObjectParserDelegate<VerificationRule>?  CustomVerificationRuleParser   = null)
        {
            ...
            try
            {
                ...
                if (JSON.ParseOptionalJSON("keyPair",
                                           ...
                                           OverlayNetworking.KeyPair.TryParse,
                                           out KeyPair? KeyPair,
                                           out ErrorResponse))
                {
