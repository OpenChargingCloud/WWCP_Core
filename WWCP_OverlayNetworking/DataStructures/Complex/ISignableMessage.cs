...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking
{
    ...
    /// <summary>
    /// Extension methods for signable EEBus CSE messages.
    /// </summary>
    public static class ISignableMessageExtensions
    {
        ...
        /// <summary>
        /// Sign the given binary EEBus message.
        /// </summary>
        /// <param name="SignableMessage">A signable message.</param>
    ...
    /// <summary>
    /// The common interface of all signable EEBus CSE messages.
    /// </summary>
