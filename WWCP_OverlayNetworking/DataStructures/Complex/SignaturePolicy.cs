...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking
{
    ...
    /// <summary>
    /// An EEBus CSE cryptographic signature policy.
    /// </summary>
                                   ...
                                   IEquatable<SignaturePolicy>
    {
        ...
        /// <summary>
        /// Create a new EEBus CSE cryptographic signature policy.
        /// </summary>
                                       ...
                                       CustomJObjectParserDelegate<SignaturePolicy>?  CustomSignaturePolicyParser)
        {
            ...
            try
            {
                ...
                #region Signatures           [optional, EEBus_CSE]
                ...
                if (JSON.ParseOptionalJSON("customData",
                                           "custom data",
                                           OverlayNetworking.CustomData.TryParse,
            ...
            try
            {
                     ...
                     HasSigningRules(SignableMessage.Context, out signaturePolicyEntries))
                {
                    ...
                    foreach (var signInfo in signInfos)
                    {
                        ...
                        var plainText   = JSONMessage.ToString(Formatting.None, OverlayNetworking.SignableMessage.DefaultJSONConverters);
                                     ...
                                     [NotNullWhen(false)] out String?  ErrorResponse)
        {
            ...
            try
            {
                ...
                var jsonMessageCopy  = JObject.Parse(JSONMessage.ToString(Formatting.None, OverlayNetworking.SignableMessage.DefaultJSONConverters));
                jsonMessageCopy.Remove("signatures");

                var plainText = jsonMessageCopy.ToString(Formatting.None, OverlayNetworking.SignableMessage.DefaultJSONConverters);
                                     ...
                                     [NotNullWhen(false)] out String?  ErrorResponse)
        {
            ...
            try
            {
                ...
                //var jsonMessageCopy  = Byte[].Parse(BinaryMessage.ToString(Formatting.None, OverlayNetworking.SignableMessage.DefaultJSONConverters));
                //jsonMessageCopy.Remove("signatures");
