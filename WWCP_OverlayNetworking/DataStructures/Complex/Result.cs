...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking
{
    ...
    public class Result : IEquatable<Result>
    {
        ...
        /// <summary>
        /// Create a new generic EEBus result.
        /// </summary>
        ...
        /// </summary>
        /// <param name="DestinationNodeId">The unique identification of the unknown or unreachable networking node.</param>
