...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking
{
    ...
    /// <summary>
    /// Extension methods for EEBus result codes.
    /// </summary>
    public static class ResultCodeExtensions
    {

        /// <summary>
        /// Indicates whether this EEBus result code is null or empty.
        /// </summary>
        /// <param name="ResultCode">An EEBus result code.</param>
                                        ...
                                        IComparable<ResultCode>
    {
        ...
        /// <summary>
        /// Create a new EEBus result code based on the given text.
        /// </summary>
        ...
        /// <summary>
        /// Parse the given string as an EEBus result code.
        /// </summary>
        /// <param name="Text">A text representation of an EEBus result code.</param>
        public static ResultCode Parse(String Text)
        {
            ...
            throw new ArgumentException($"Invalid text representation of an EEBus result code: '{Text}'!",
                                        nameof(Text));
        ...
        /// <summary>
        /// Try to parse the given text as an EEBus result code.
        /// </summary>
        /// <param name="Text">A text representation of an EEBus result code.</param>
        ...
        /// </summary>
        /// <param name="Text">A text representation of an EEBus result code.</param>
        /// <param name="resultCode">The parsed EEBus result code.</param>
        ...
        /// </summary>
        /// <param name="ResultCode1">An EEBus result code.</param>
        /// <param name="ResultCode2">Another EEBus result code.</param>
        ...
        /// <summary>
        /// Compares two EEBus result codes.
        /// </summary>
        /// <param name="Object">An EEBus result code to compare with.</param>
        public Int32 CompareTo(Object? Object)

            => Object is ResultCode resultCode
                   ? CompareTo(resultCode)
                   : throw new ArgumentException("The given object is not an EEBus result code!",
                                                 nameof(Object));
        ...
        /// Compares two EEBus result codes.
        /// </summary>
        /// <param name="resultCode">An EEBus result code to compare with.</param>
        ...
        /// <summary>
        /// Compares two EEBus result codes for equality.
        /// </summary>
        /// <param name="Object">An EEBus result code to compare with.</param>
