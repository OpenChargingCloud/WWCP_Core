...
namespace cloud.charging.open.protocols.WWCP.OverlayNetworking
{
    ...
    /// <summary>
    /// An abstract generic EEBus request.
    /// </summary>
    /// <typeparam name="TRequest">The type of the EEBus request.</typeparam>
...

    {
        ...
        /// <summary>
        /// Compare two abstract generic EEBus requests for equality.
        /// </summary>
        /// <param name="TRequest">Another abstract generic EEBus request.</param>
        ...
        /// Compare two abstract generic EEBus requests for equality.
        /// </summary>
        /// <param name="ARequest">Another abstract generic EEBus request.</param>
