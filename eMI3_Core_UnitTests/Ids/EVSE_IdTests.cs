...
namespace org.emi3group.UnitTests
{
    ...
    public class EVSE_IdTests
    {
        ...
        #region EVSE_IdEmptyConstructorTest()

        /// <summary>
        /// A test for an empty EVSE_Id constructor.
        /// </summary>
        [Test]
        public void EVSE_IdEmptyConstructorTest()
        {
            var _EVSE_Id1 = new EVSE_Id();
            var _EVSE_Id2 = new EVSE_Id();
            Assert.IsTrue(_EVSE_Id1.Length > 0);
            Assert.IsTrue(_EVSE_Id2.Length > 0);
            Assert.AreNotEqual(_EVSE_Id1, _EVSE_Id2);
        }
        ...
        #region EVSE_IdEVSE_IdConstructorTest()

        /// <summary>
        /// A test for the EVSE_Id EVSE_Id constructor.
        /// </summary>
        [Test]
        public void EVSE_IdEVSE_IdConstructorTest()
        {
            var _EVSE_Id1 = EVSE_Id.New;
            var _EVSE_Id2 = _EVSE_Id1.Clone;
            Assert.AreEqual(_EVSE_Id1.ToString(), _EVSE_Id2.ToString());
            Assert.AreEqual(_EVSE_Id1.Length,     _EVSE_Id2.Length);
            Assert.AreEqual(_EVSE_Id1,            _EVSE_Id2);
        }

        #endregion


        #region NewEVSE_IdMethodTest()

        /// <summary>
        /// A test for the static newEVSE_Id method.
        /// </summary>
        [Test]
        public void NewEVSE_IdMethodTest()
        {
            var _EVSE_Id1 = EVSE_Id.New;
            var _EVSE_Id2 = EVSE_Id.New;
            Assert.AreNotEqual(_EVSE_Id1, _EVSE_Id2);
        }
        ...
        public void op_Equality_SameReference_Test()
        {
            ...
            Assert.IsTrue(_EVSE_Id1 == _EVSE_Id1);
        ...
        {
            var _EVSE_Id1 = new EVSE_Id("1");
            var _EVSE_Id2 = new EVSE_Id("1");
            Assert.IsTrue(_EVSE_Id1 == _EVSE_Id2);
        }
        ...
        public void op_Inequality_SameReference_Test()
        {
            var _EVSE_Id1 = new EVSE_Id();
            #pragma warning disable
            Assert.IsFalse(_EVSE_Id1 != _EVSE_Id1);
            #pragma warning restore
        }
        ...
        {
            var _EVSE_Id1 = new EVSE_Id("5");
            var _EVSE_Id2 = new EVSE_Id("23");
            Assert.IsTrue(_EVSE_Id1 != _EVSE_Id2);
        }
        ...
        {
            var _EVSE_Id1 = new EVSE_Id("23");
            var _EVSE_Id2 = new EVSE_Id("5");
            Assert.IsFalse(_EVSE_Id1 < _EVSE_Id2);
        }
        ...
        {
            var    _EVSE_Id = EVSE_Id.New;
            Object _Object   = null;
            _EVSE_Id.CompareTo(_Object);
        }
        ...
        {
            var      _EVSE_Id = EVSE_Id.New;
            EVSE_Id _Object   = null;
            _EVSE_Id.CompareTo(_Object);
        }

        #endregion

        #region CompareToNonEVSE_IdTest()

        /// <summary>
        /// A test for CompareTo a non-EVSE_Id.
        /// </summary>
        [Test]
        [ExpectedException(typeof(ArgumentException))]
        public void CompareToNonEVSE_IdTest()
        {
            var _EVSE_Id = EVSE_Id.New;
            var _Object   = "123";
            _EVSE_Id.CompareTo(_Object);
        ...
        public void EqualsNullTest1()
        {
            var    _EVSE_Id = EVSE_Id.New;
            Object _Object   = null;
            Assert.IsFalse(_EVSE_Id.Equals(_Object));
        }
        ...
        #region EqualsNonEVSE_IdTest()

        /// <summary>
        /// A test for equals a non-EVSE_Id.
        /// </summary>
        [Test]
        public void EqualsNonEVSE_IdTest()
        {
            var _EVSE_Id = EVSE_Id.New;
            var _Object   = "123";
            Assert.IsFalse(_EVSE_Id.Equals(_Object));
        ...
        {
            var _SensorHashCode1 = new EVSE_Id("5").GetHashCode();
            var _SensorHashCode2 = new EVSE_Id("5").GetHashCode();
        ...
        {
            var _SensorHashCode1 = new EVSE_Id("1").GetHashCode();
            var _SensorHashCode2 = new EVSE_Id("2").GetHashCode();
