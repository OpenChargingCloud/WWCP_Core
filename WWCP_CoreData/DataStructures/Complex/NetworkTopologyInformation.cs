...
namespace cloud.charging.open.protocols.WWCP.NetworkingNode
{
                                              ...
                                              IEquatable<NetworkTopologyInformation>
    {
        ...
        /// <param name="CustomNetworkTopologyInformationParser">An optional delegate to parse custom network topology information.</param>
        ...
        public static Boolean TryParse(JObject                                               JSON,
                                       [NotNullWhen(true)]  out NetworkTopologyInformation?  NetworkTopologyInformation,
