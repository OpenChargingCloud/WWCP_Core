...
namespace cloud.charging.open.protocols.WWCP.Virtual
{
    ...
    public static class VirtualChargingStationExtensions
    {
        ...
        public static IChargingStation? CreateVirtualStation(this IChargingPool                          ChargingPool,
                                          ...
                                          IRemoteChargingStation
    {
...

        {
            ...
            try
            {
                    ...
                    newReservation != null)
                {
                    ...
                    foreach (var subReservation in newReservation.SubReservations)
                        reservations.Add(subReservation.Id, subReservation);
...

        {
            ...
            {
                DebugX.LogException(e, nameof(VirtualChargingStation) + "." + nameof(OnRemoteStartRequest));
            }
            ...
            {
                DebugX.LogException(e, nameof(VirtualChargingStation) + "." + nameof(OnRemoteStartResponse));
            }
        ...
        public IVotingSender<DateTime, IChargingStation, IEVSE, Boolean> OnEVSEAddition => throw new NotImplementedException();
