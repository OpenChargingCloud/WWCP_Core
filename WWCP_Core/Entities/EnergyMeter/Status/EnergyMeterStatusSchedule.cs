...
namespace cloud.charging.open.protocols.WWCP
{
    ...
    /// <summary>
    /// Extension methods for the energy meter status schedule.
    /// </summary>
    public static class EnergyMeterStatusScheduleExtensions
    {

        #region ToJSON(this EnergyMeterStatusSchedules, Skip = null, Take = null, HistorySize = 1)

        public static JObject ToJSON(this IEnumerable<EnergyMeterStatusSchedule>  EnergyMeterStatusSchedules,
                                     UInt64?                                          Skip          = null,
                                     UInt64?                                          Take          = null,
                                     UInt64                                           HistorySize   = 1)
        {
            ...
            if (EnergyMeterStatusSchedules is null || !EnergyMeterStatusSchedules.Any())
                return new JObject();
            ...
            var filteredStatus = new Dictionary<EnergyMeter_Id, EnergyMeterStatusSchedule>();

            foreach (var status in EnergyMeterStatusSchedules)
            {
    ...
    /// </summary>
    public class EnergyMeterStatusSchedule : AInternalData
    {
        ...
        /// </summary>
        public StatusSchedule<EnergyMeterStatusTypes>  StatusSchedule    { get; }
        ...
        public EnergyMeterStatusSchedule(EnergyMeter_Id                          Id,
                                             StatusSchedule<EnergyMeterStatusTypes>  StatusSchedule,
