...
namespace org.GraphDefined.WWCP
{
...

    {
        ...
        /// </summary>
        public  static readonly Regex  ChargingTariffId_RegEx  = new Regex(@"^([A-Z]{2}\*?[A-Z0-9]{3})\*?T([A-Z0-9][A-Z0-9\*]{0,30})$",
        ...
        public static ChargingTariff_Id Parse(ChargingStationOperator_Id  OperatorId,
            ...
            => Parse(OperatorId.ToFormat(OperatorIdFormats.ISO_STAR) + "*T" + Suffix);
