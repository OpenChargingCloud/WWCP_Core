...
namespace org.GraphDefined.WWCP
{
...

    {
        ...
        public static GridOperator_Id Parse(String CountryAndProviderId)
        {
            ...
            if (Country.TryParseAlpha2Code(_MatchCollection[0].Groups[1].Value, out __CountryCode))
            {
                ...
                return new GridOperator_Id(__CountryCode,
                                   Separator,
        ...
        public static Boolean TryParse(String       CountryAndProviderId,
                                       out GridOperator_Id  EVSEProviderId)
        {
            ...
            try
            {
                ...
                if (Country.TryParseAlpha2Code(_MatchCollection[0].Groups[1].Value, out __CountryCode))
                {
                    ...
                    EVSEProviderId = new GridOperator_Id(__CountryCode,
                                                 Separator,
                                                 _MatchCollection[0].Groups[3].Value);
                                       ...
                                       out GridOperator_Id  EVSEProviderId)
        {
            ...
            try
            {
                ...
                EVSEProviderId = new GridOperator_Id(CountryCode,
        ...
        public GridOperator_Id ChangeIdFormat(ProviderIdFormats NewIdFormat)
        {
            return new GridOperator_Id(this._CountryCode, NewIdFormat, this.ProviderId);
        }
        ...
        public static Boolean operator == (GridOperator_Id EVSPId1, GridOperator_Id EVSPId2)
        {
        ...
        public Int32 CompareTo(Object Object)
        {
            ...
            var EVSPId = Object as GridOperator_Id;
        ...
        public Int32 CompareTo(GridOperator_Id EVSPId)
        {
        ...
        public Boolean Equals(GridOperator_Id EVSPId)
        {
