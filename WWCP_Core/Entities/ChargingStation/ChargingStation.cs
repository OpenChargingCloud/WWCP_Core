...
namespace org.GraphDefined.WWCP
{
                                   ...
                                   IStatus<ChargingStationStatusType>
    {
                                                                     ...
                                                                     TimeSpan?                              QueryTimeout  = null)
        {
            ...
            var result = await _EVSEs.Where   (evse => evse.Reservation    != null &&
                                                       evse.Reservation.Id == ReservationId).
...

        {
            ...
            {
                e.Log("ChargingStation." + nameof(OnRemoteChargingStationStop));
            }
            ...
            {
                e.Log("ChargingStation." + nameof(OnRemoteChargingStationStopped));
            }
