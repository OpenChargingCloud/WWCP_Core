...
namespace cloud.charging.open.protocols.WWCP.Virtual
{
                                          ...
                                          IRemoteChargingStation
    {
        ...
        internal readonly IVotingNotificator<DateTimeOffset, EventTracking_Id, User_Id, VirtualChargingStation, ChargingConnector, Boolean> ChargingConnectorAddition;

        /// <summary>
        /// Called whenever a socket outlet will be or was added.
        /// </summary>
        public IVotingSender<DateTimeOffset, EventTracking_Id, User_Id, VirtualChargingStation, ChargingConnector, Boolean> OnChargingConnectorAddition
        {
            get
            {
        ...
        internal readonly IVotingNotificator<DateTimeOffset, EventTracking_Id, User_Id, VirtualChargingStation, ChargingConnector, Boolean> ChargingConnectorRemoval;

        /// <summary>
        /// Called whenever a socket outlet will be or was removed.
        /// </summary>
        public IVotingSender<DateTimeOffset, EventTracking_Id, User_Id, VirtualChargingStation, ChargingConnector, Boolean> OnChargingConnectorRemoval
        {
            get
            {
...

        {
            ...
            try
            {
                         ...
                         AdminStatus.Value == ChargingStationAdminStatusTypes.InternalUse)
                {
                    ...
                    else
                    {
                            ...
                            TryGetEVSEById(ChargingLocation.EVSEId.Value, out var remoteEVSE))
                        {
                            ...
                            result = await remoteEVSE.Reserve(
                                               ChargingLocation,
                                               ReservationLevel,
                                               ReservationStartTime,
                                               Duration,
                    ...
                    newReservation is not null)
                {
                    ...
                    chargingReservations.Add(
                        newReservation.Id,
                        new ChargingReservationCollection(newReservation)
                    );

                    foreach (var subReservation in newReservation.SubReservations)
                        chargingReservations.Add(
                            subReservation.Id,
                            new ChargingReservationCollection(subReservation)
                        );
        ...
        public Func<EVSEStatusReport, ChargingStationStatusType> StatusAggregationDelegate { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

        public IVotingSender<DateTimeOffset, User_Id, IChargingStation, IEVSE, Boolean> OnEVSEAddition => throw new NotImplementedException();

        public IVotingSender<DateTimeOffset, User_Id, IChargingStation, IEVSE, Boolean> OnEVSERemoval => throw new NotImplementedException();
        ...
        public IVotingSender<DateTimeOffset, User_Id, IChargingStation, IEVSE, IEVSE, Boolean> OnEVSEUpdate => throw new NotImplementedException();
        ...
        public Task<AddEVSEResult> AddEVSE(EVSE_Id Id, I18NString? Name = null, I18NString? Description = null, Timestamped<EVSEAdminStatusType>? InitialAdminStatus = null, Timestamped<EVSEStatusType>? InitialStatus = null, UInt16? MaxAdminStatusScheduleSize = null, UInt16? MaxStatusScheduleSize = null, IEnumerable<URL>? PhotoURLs = null, IEnumerable<Brand>? Brands = null, IEnumerable<DataLicense>? OpenDataLicenses = null, IEnumerable<ChargingModes>? ChargingModes = null, IEnumerable<ChargingTariff>? ChargingTariffs = null, CurrentTypes? CurrentType = null, Decimal? MaxVoltage = null, Timestamped<Decimal>? MaxVoltageRealTime = null, IEnumerable<Timestamped<Decimal>>? MaxVoltagePrognoses = null, Decimal? MaxCurrent = null, Timestamped<Decimal>? MaxCurrentRealTime = null, IEnumerable<Timestamped<Decimal>>? MaxCurrentPrognoses = null, Decimal? MaxPower = null, Timestamped<Decimal>? MaxPowerRealTime = null, IEnumerable<Timestamped<Decimal>>? MaxPowerPrognoses = null, Decimal? MaxCapacity = null, Timestamped<Decimal>? MaxCapacityRealTime = null, IEnumerable<Timestamped<Decimal>>? MaxCapacityPrognoses = null, EnergyMix? EnergyMix = null, Timestamped<EnergyMix>? EnergyMixRealTime = null, EnergyMixPrognosis? EnergyMixPrognoses = null, EnergyMeter? EnergyMeter = null, Boolean? IsFreeOfCharge = null, IEnumerable<IChargingConnector>? ChargingConnectors = null, ChargingSession? ChargingSession = null, DateTime? LastStatusUpdate = null, String? DataSource = null, DateTime? LastChange = null, JObject? CustomData = null, UserDefinedDictionary? InternalData = null, Action<IEVSE>? Configurator = null, RemoteEVSECreatorDelegate? RemoteEVSECreator = null, Action<IEVSE>? OnSuccess = null, Action<IChargingStation, EVSE_Id>? OnError = null)
        {
            throw new NotImplementedException();
        }
