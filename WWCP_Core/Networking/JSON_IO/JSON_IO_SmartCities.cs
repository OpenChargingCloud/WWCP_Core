...
namespace org.GraphDefined.WWCP.Net.IO.JSON
{
    ...
    public static partial class JSON_IO
    {
        ...
        public static void Attach_JSON_IO_SmartCities(this WWCP_HTTPAPI  WWCPAPI,
                                                      ...
                                                      HTTPPath?           _URIPrefix  = null)
        {
            ...
            // -----------------------------------------------------------------------------------------
            WWCPAPI.HTTPServer.AddMethodCallback(Hostname,
                                                 HTTPMethod.GET,
            ...
            WWCPAPI.HTTPServer.AddMethodCallback(HTTPHostname.Any,
                                                 ...
                                                 HTTPDelegate: Request => {
                                                     ...
                                                     if (!Request.ParseRoamingNetworkAndSmartCity(WWCPAPI,
                                                                                                  out _RoamingNetwork,
                                                                                                  out _SmartCity,
                                                                                                  out _HTTPResponse))
