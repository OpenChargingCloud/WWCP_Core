...
namespace org.GraphDefined.WWCP
{
    ...
    public class AuthStartResult
    {
        ...
        private readonly AuthStartResultType _Result;

        /// <summary>
        /// The result of the authorize start operation.
        /// </summary>
        public AuthStartResultType  AuthorizationResult
        {
            get
            {
                return _Result;
        ...
        #region (private) AuthStartResult(AuthorizatorId, Result, ProviderId = null, Description = null, AdditionalInfo = null)
        ...
        #region (private) AuthStartResult(AuthorizatorId, SessionId, ProviderId, Description = null, AdditionalInfo = null, ListOfAuthStopTokens = null, ListOfAuthStopPINs = null)
                                    ...
                                    IEnumerable<UInt32>      ListOfAuthStopPINs    = null)
        {
            ...
            this._Result                = AuthStartResultType.Authorized;
            this._AuthorizatorId        = AuthorizatorId;
        ...
        #region (private) AuthStartResult(AuthorizatorId, ErrorMessage = null)
                                    ...
                                    String           ErrorMessage  = null)
        {
            ...
            this._Result                = AuthStartResultType.Error;
            this._AuthorizatorId        = AuthorizatorId;
        ...
        /// <param name="ListOfAuthStopTokens">An optional enumeration of authorize stop tokens.</param>
        /// <param name="ListOfAuthStopPINs">An optional enumeration of authorize stop PINs.</param>
        public static AuthStartResult Authorized(Authorizator_Id          AuthorizatorId,
                                                     ChargingSession_Id       SessionId,
                                                     EVSP_Id                  ProviderId,
                                                     String                   Description           = null,
                                                     String                   AdditionalInfo        = null,
        ...
        /// <param name="Description">An optional description of the auth start result.</param>
        /// <param name="AdditionalInfo">An optional additional message.</param>
        public static AuthStartResult Blocked(Authorizator_Id  AuthorizatorId,
                                                  EVSP_Id          ProviderId,
                                                  String           Description     = null,
                                                  String           AdditionalInfo  = null)
        {
