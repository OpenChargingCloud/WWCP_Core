    ...
    public class RemoteStopRequest : ARequest<RemoteStopRequest>
    {
...

        {
            ...
            unchecked
            {
                ...
                hashCode = this.ChargingSessionId.    GetHashCode()       * 11 ^
                          (this.RemoteAuthentication?.GetHashCode() ?? 0) *  7 ^
        ...
        /// <param name="Timestamp">The optional timestamp of the request.</param>
        /// <param name="EventTrackingId">An optional event tracking identification for correlating this request with other events.</param>
        /// <param name="CustomRemoteStopRequestParser">A delegate to parse custom RemoteStop JSON objects.</param>
        ...
        /// <param name="Timestamp">The optional timestamp of the request.</param>
        /// <param name="EventTrackingId">An optional event tracking identification for correlating this request with other events.</param>
        /// <param name="CustomRemoteStopRequestParser">A delegate to parse custom RemoteStop request JSON objects.</param>
                                       ...
                                       CustomJObjectParserDelegate<RemoteStopRequest>?  CustomRemoteStopRequestParser   = null)
        {
            ...
            try
            {
                ...
                RemoteStopRequest = new RemoteStopRequest(ChargingSessionId,
