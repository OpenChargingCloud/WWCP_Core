...
namespace org.GraphDefined.WWCP.Net.IO.JSON
{
    ...
    public static partial class JSON_IO
    {
        ...
        #region ToJSON(this ParkingOperators, Skip = 0, Take = 0, Embedded = false, ExpandChargingRoamingNetworkId = false, ExpandChargingStationIds = false, ExpandChargingStationIds = false, ExpandEVSEIds = false)
        ...
        #region ToJSON(this ParkingOperatorAdminStatus, Skip = 0, Take = 0, HistorySize = 1)
...

        {
            ...
            try
            {
                ...
                var _StatusHistory = Take == 0
                                         ? ParkingOperatorAdminStatus.Skip(Skip)
                                         : ParkingOperatorAdminStatus.Skip(Skip).Take(Take);
        ...
        #region ToJSON(this ParkingOperatorStatus,      Skip = 0, Take = 0, HistorySize = 1)
...

        {
            ...
            try
            {
                ...
                var _StatusHistory = Take == 0
                                         ? ParkingOperatorStatus.Skip(Skip)
                                         : ParkingOperatorStatus.Skip(Skip).Take(Take);
