...
namespace org.GraphDefined.WWCP
{
    ...
    public delegate Task<ReservationResult> OnReserveChargingPoolDelegate(CancellationToken       CancellationToken,
                                                                          DateTime                Timestamp,
    ...
    /// <param name="Duration">The duration of the reservation. [default: 30 min]</param>
    /// <returns>A RemoteStartResult task.</returns>
    public delegate Task<ReservationResult> OnReserveChargingStationDelegate(CancellationToken       CancellationToken,
                                                                             DateTime                Timestamp,
                                                                             RoamingNetwork_Id       RoamingNetworkId,
                                                                             ChargingReservation_Id  ReservationId,
                                                                             EVSP_Id                 ProviderId,
